...
const AboutSection: React.FC = () => {
  return (
    <Element name="about">
      <section className="appliedBgOnCustom w-screen h-fit flex flex-col ">
        <main className=" w-full h-fit pt-28 flex flex-col items-center  px-5 ">
          <m.em
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 1 }}
            className="border-b-2 border-blurLight px-10 flex font-bold "
          >
            ...
            >
              ...
              <div className="w-fit h-fit flex flex-col items-start opacity-80">
                ...
                <p className="mt-2 text-xs  pr-16 lg:text-sm lg:pr-0 flex items-start justify-start ">
                  <MdLocalPhone className="w-4 h-4 mr-2" /> +639506863050
                </p>
              ...
              >
                <div className="p-2 mr-4 border-2 rounded-full border-textLight dark:border-textDark hover:-translate-y-1 transition-all cursor-pointer">
                  <TfiGithub className="w-3 h-3 lg:w-4 lg:h-4 " />
                </div>
                <div className="p-2 mr-4 border-2 rounded-full border-textLight dark:border-textDark hover:-translate-y-1 transition-all cursor-pointer">
                  <TfiTwitterAlt className="w-3 h-3 lg:w-4 lg:h-4 " />
                </div>
                <div className="p-2 mr-4 border-2 rounded-full border-textLight dark:border-textDark hover:-translate-y-1 transition-all cursor-pointer">
                  <TfiFacebook className="w-3 h-3 lg:w-4 lg:h-4 " />
                </div>
              </m.div>
              ...
              <m.button
                ...
                transition={{ duration: 1 }}
                className="w-fit h-fit bg-secondaryLight dark:bg-secondaryDark text-textDark py-2 px-10 mt-14 xl:mt-16"
              >
                Hire me
              </m.button>
          ...
          <section className="w-full h-fit mt-20 flex flex-col  justify-between px-5  lg:flex-col lg:items-center lg:justify-center lg:my-20">
            <m.em
              initial={{ opacity: 0, translateX: 80 }}
              whileInView={{ opacity: 1, translateX: 0 }}
              transition={{ duration: 1 }}
