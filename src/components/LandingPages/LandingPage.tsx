...
const LandingPage = () => {
  ...
  return (
    <main className="bg-lightPrimary dark:bg-darkPrimary w-screen h-fit overflow-hidden">
      ...
      <header className=" w-full h-20 fixed top-0  shadow-sm border-b-[0.02px] bg-lightPrimary dark:bg-darkPrimary dark:border-b-darkSecondary z-50 lg:pt-5 lg:h-20">
        <NavigationSection/>
      </header>
